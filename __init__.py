...
bl_info = {
    "name": "Geklmin Custom OBJ Variant format with Per-Vertex colors or bone weights",
    "author": "Geklmin",
    "version": (1, 0, 0),
    "blender": (2, 78, 0),
    "location": "File > Import-Export",
    "description": "Export GK OBJ",
    "warning": "",
...
def menu_func_export(self, context):
    self.layout.operator(ExportOBJ.bl_idname, text="GeklminRender (.obj)")
